...
var Intense = (function() {
    ...
    function createViewer( title, caption, intro ) {
      ...
      if ( intro ) {
        var captionintroProperties = {
          'fontSize': '1.1em',
          'letterSpacing': '0.5px',
          'max-width': '50%',
        }
        var captionintro = document.createElement( 'p' );
        applyProperties( captionintro, captionintroProperties );
        captionintro.innerHTML = intro;
        captionContainer.appendChild( captionintro );
      }
    ...
    function init( element ) {
      ...
      img.onload = function() {
        ...
        target = this;
        createViewer( title, caption, intro );
        lockBody();
        bindEvents();
        loop();
      }
